...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class  MagazineEjectForceAction : FsmStateAction
	{
		...
		[Tooltip("Set magazine ejection force.")]
		// add the variables you want in your action
		public FsmFloat magEject;
		...
		void MakeItSo()
		{
			...
			theScript.magEjectForce = magEject.Value;

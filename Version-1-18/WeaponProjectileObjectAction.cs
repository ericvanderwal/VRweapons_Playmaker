...
namespace HutongGames.PlayMaker.Actions
{
	...
	[Tooltip("Adjust projectile object for projectile weapons in VRweapons script")]

	// the class must match the name of the action
	// if the action is named missleAction then that should be the name of the class
	public class WeaponProjectileObjectAction : FsmStateAction
	{
		[RequiredField]
		...
		[Tooltip("Set projectile object for projectile weapons.")]
		// add the variables you want in your action
		public FsmGameObject weaponProjectile;
		...
		void DoTheMagic()
		{
			...
			theScript.projectile = weaponProjectile.Value;

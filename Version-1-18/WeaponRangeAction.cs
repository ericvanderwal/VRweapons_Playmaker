...
namespace HutongGames.PlayMaker.Actions
{
	...
	public class WeaponRangeAction : FsmStateAction
	{
		...
		[Tooltip("Set the weapon range float here.")]
		// add the variables you want in your action
		public FsmFloat weaponRange;
		...
		void MakeItSo()
		{
			...
			theScript.range = weaponRange.Value;

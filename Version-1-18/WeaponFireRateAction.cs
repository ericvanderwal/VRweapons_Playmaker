	...
	public class WeaponFireRateAction : FsmStateAction
		{
			...
			[Tooltip("Set the weapon fire rate float here.")]
			...
			void MakeItSo()
			{
				...
				theScript.fireRate = fireRate.Value;
